...
public class LatlngActivity extends Activity implements LocationListener {
...
/** Called when the activity is first created. */
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    getadd_btn=(Button)findViewById(R.id.getadd_btn);
//    try {
//        Geocoder geocoder;
...
//
//    }
 getadd_btn.setOnClickListener(new OnClickListener() {
		
		@Override
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Toast.makeText(getApplicationContext(), "is clicked", Toast.LENGTH_SHORT).show();
			Intent i=new Intent(LatlngActivity.this,GetAddressActivity.class);
			i.putExtra("LAT","17.3998");
			i.putExtra("LNG", "78.4766");
			startActivity(i);
		}
	});
